 ...
 * extended; all references should be to Autore
 */
@SuppressWarnings("unused")
public abstract class BaseAutore 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1747345532384L;



    /** Codice identificativo dell'autore */
     ...
     * Codice identificativo dell'autore
     *
     * @return the value of id as Integer
     */
     ...
     * Otherwise if this BaseAutore has previously
     * been saved, it will retrieve related collLibros from storage.
     * If this BaseAutore is new, it will return
    ...
    public List<Libro> getLibros(Criteria criteria) throws TorqueException
    {
        if (collLibros == null)
        {
            ...
            {
                criteria.and(org.example.LibroPeer.AUTORE, getId());
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this BaseAutore is new, it will return
     ...
     */
    protected List<Libro> getLibrosJoinGenere(Criteria criteria) throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(criteria.getDbName()))
        {
            List<Libro> result = getLibrosJoinGenere(criteria, connection);
     ...
     * an identical criteria, it returns the collection.
     * Otherwise if this BaseAutore is new, it will return
     * an empty collection; or if this BaseAutore has previously
     * been saved, it will retrieve the related objects from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can change the access modifier to public
     * by overriding this method in the child class.
     */
    protected List<Libro> getLibrosJoinGenere(Criteria criteria, Connection connection)
        throws TorqueException
    {
        if (collLibros == null)
        {
            ...
            {
                criteria.and(org.example.LibroPeer.AUTORE, getId());
                collLibros = org.example.LibroPeer.doSelectJoinGenere(criteria, connection);
                for (Libro libro : collLibros)
                {
                    libro.setAutore((Autore) this);
                }
    ...
    {
        if (org.example.AutorePeer.ID.getSqlExpression().equals(name)
            || org.example.AutorePeer.ID.getColumnName().equals(name))
        {
            return getId();
        }
        if (org.example.AutorePeer.NOME.getSqlExpression().equals(name)
            || org.example.AutorePeer.NOME.getColumnName().equals(name))
        {
            return getNome();
        }
        if (org.example.AutorePeer.COGNOME.getSqlExpression().equals(name)
            || org.example.AutorePeer.COGNOME.getColumnName().equals(name))
        {
            return getCognome();
        }
        return null;
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    AutorePeer.doInsert((Autore) this, con);
                    setNew(false);
                }
                else
                {
                    AutorePeer.doUpdate((Autore) this, con);
                }
            }
    ...
    {
        setId(Integer.valueOf(((NumberKey) key).intValue()));
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails  
     */
    public Autore copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails     
     */
    public Autore copy(Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Autore copy(boolean deepcopy) throws TorqueException
    {
        Autore autore = new Autore();

        return copyInto(autore, deepcopy);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Autore copy(boolean deepcopy, Connection con) throws TorqueException
    {
        Autore autore = new Autore();

        return copyInto(autore, deepcopy, con);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Autore copyInto(Autore copyObj) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Autore copyInto(Autore copyObj, Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    protected Autore copyInto(Autore copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Autore copyInto(Autore copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId((Integer) null);
        copyObj.setNome(nome);
        copyObj.setCognome(cognome);
    ...
    /** The Peer class */
    private static final org.example.AutorePeer peer
            = new org.example.AutorePeer();
     ...
     */
    public org.example.AutorePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return org.example.AutorePeer.getTableMap();
    }
     ...
     */
    public boolean valueEquals(Autore toCompare)
    {
        if (toCompare == null)
        {
            return false;
        ...
        if (!Objects.equals(this.id, toCompare.getId()))
        {
            return false;
        }
